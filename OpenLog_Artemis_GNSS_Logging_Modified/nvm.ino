...
void recordSettingsToFile()
{
  if (online.microSD == true)
  {
    ...
    // Added these IMU settings - Amara
    settingsFile.print("IMU:log="); settingsFile.println(settings.sensor_IMU.log);
    settingsFile.print("IMU:enableAccel="); settingsFile.println(settings.sensor_IMU.enableAccel);
    settingsFile.print("IMU:enableGyro="); settingsFile.println(settings.sensor_IMU.enableGyro);
    settingsFile.print("IMU:enableMag="); settingsFile.println(settings.sensor_IMU.enableMag);
    settingsFile.print("IMU:enableTemp="); settingsFile.println(settings.sensor_IMU.enableTemp);
    settingsFile.print("IMU:logRateMs="); settingsFile.println(settings.sensor_IMU.logRateMs);
...
bool parseLine(char* str) {
  ...
  // Added these IMU setting parsers - Amara
  else if (strcmp(settingName, "IMU:log") == 0)
    settings.sensor_IMU.log = d;
  else if (strcmp(settingName, "IMU:enableAccel") == 0)
    settings.sensor_IMU.enableAccel = d;
  else if (strcmp(settingName, "IMU:enableGyro") == 0)
    settings.sensor_IMU.enableGyro = d;
  else if (strcmp(settingName, "IMU:enableMag") == 0)
    settings.sensor_IMU.enableMag = d;
  else if (strcmp(settingName, "IMU:enableTemp") == 0)
    settings.sensor_IMU.enableTemp = d;
  else if (strcmp(settingName, "IMU:logRateMs") == 0)
    settings.sensor_IMU.logRateMs = d;
  else
  {
